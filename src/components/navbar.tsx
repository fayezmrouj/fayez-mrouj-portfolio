...
import { Menu, X, Download, Printer } from "lucide-react";
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              aria-label="Print CV"
              className="hidden h-9 w-9 items-center justify-center rounded-full border border-border bg-background/70 backdrop-blur transition-colors hover:border-primary/40 hover:bg-accent sm:inline-flex"
              title="Print CV (opens CV PDF)"
            >
